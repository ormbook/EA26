...
input ENUM_ENGINE_A_MODE InpEngineA_Mode = A_MODE_NORMAL; // Engine A Strategy
...
input ENUM_ENGINE_B_MODE InpEngineB_Mode = B_MODE_NORMAL; // Engine B Strategy
...
input ENUM_ENGINE_D_MODE InpEngineD_Mode = D_MODE_NORMAL; // Engine D Strategy
