...
enum ENUM_RISK_LEVEL {
    RISK_MANUAL = 0,           // Manual Settings
    RISK_1_SLEEP = 1,          // Level 1: Sleep (Safest)
    RISK_2_SAFE = 2,           // Level 2: Safe
    RISK_3_BALANCE = 3,        // Level 3: Balance
    RISK_4_ATTACK = 4,         // Level 4: Attacking
    RISK_5_AGGRESSIVE = 5      // Level 5: Aggressive (Highest Risk/Return)
};
